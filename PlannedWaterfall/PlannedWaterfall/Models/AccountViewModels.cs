...
namespace PlannedWaterfall.Models
{
    public class ToExcelModel
    {
        [Display(Name = "Feature")]
        public List<string> FeatureName { get; set; }
        [Display(Name = "Low Estimate")]
        public List<int> LowEstimate { get; set; }
        [Display(Name = "High Estimate")]
        public List<int> HighEstimate { get; set; }
